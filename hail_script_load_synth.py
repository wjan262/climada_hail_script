...
load_haz_with_hdf5 = False
load_resampling_data = True #False = real data, True = Synth data
plot_img = False
haz_type = "HL"
...
years = [i for i in range(1979, 2019)]
...
def get_hail_data(years,
    ...
    for year in years:
        ...
        for i in range(start_time, xr_poh.time.size):
